...
export function TextFormulaEditor({
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className={cn(
              "p-4 border-2 rounded-[16px] text-left transition-all",
              mode === "fixed"
                ? "border-[#3182F6] bg-[#E8F3FF]"
                : "border-gray-200 bg-white hover:border-[#3182F6]/30"
            )}
          >
            <div className="font-semibold text-[15px] text-[#191F28] mb-1">
              고정값
            </div>
      ...
      {mode === "fixed" && (
        <div className="space-y-3">
          <Label htmlFor="fixed-value" className="text-[14px] font-semibold text-[#191F28]">
            고정값 ({fieldUnit})
          </Label>
          <Input
            id="fixed-value"
      ...
      {mode === "formula" && (
        <div className="space-y-4">
            ...
            <div className="relative">
                ...
                onBlur={(e) => {
                  ...
                  setTimeout(() => {
                    ...
                    className={cn(
                      "min-h-[48px] w-full rounded-md border border-input bg-background px-3 py-2 text-[14px] font-mono",
                      "ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
                      "disabled:cursor-not-allowed disabled:opacity-50 pr-10",
                      !koreanFormula && "before:content-[attr(data-placeholder)] before:text-[#C4C8CC] before:text-[12px] before:pointer-events-none"
                    )}
                    style={{
                      whiteSpace: "pre-wrap",
          ...
          {showAutocomplete && (
            <div
              ref={autocompleteRef}
                      className="absolute z-50 w-full max-w-md bg-white border-2 border-[#3182F6] rounded-[12px] shadow-lg max-h-[300px] overflow-y-auto mt-1"
              style={{
                        top: "100%",
                        left: 0,
              }}
            >
              {(() => {
                  ...
                  return (
                    <div className="p-4 text-center text-[14px] text-[#8B95A1]">
                      일치하는 변수가 없습니다
                    </div>
                  );
                      })()}
                      ...
                      return (
                        <div className="mt-2 flex flex-wrap gap-1.5">
                          {uniqueVariables.map((variable) => {
                            ...
                            const value = fullContext[variableCode];
                            ...
                            return (
                              <span
                                key={variableCode}
                                className="inline-flex items-center gap-1 px-2 py-1 bg-white border border-gray-300 rounded-[6px] text-[12px]"
                              >
            ...
            {koreanFormula && (
              <div className="flex">
                <div className="w-full bg-white rounded-[8px] border border-input shadow-[0_1px_3px_rgba(0,0,0,0.12),0_1px_2px_rgba(0,0,0,0.24)] p-8 flex flex-col justify-center">
                  {calculatePreviewResult !== null ? (
                    <div className="space-y-3">
                      <p className="text-[12px] text-[#8B95A1] font-medium uppercase tracking-wide">
                        예상 결과
                      </p>
                      <div className="flex items-baseline gap-3 flex-wrap">
                        <span className="text-[40px] font-bold text-[#1976D2] leading-tight">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-[16px] text-[#D32F2F] font-medium">
                        계산식 오류
                      </p>
                    </div>
                  )}
          ...
          {/* 사용 가능한 변수 가이드 */}
          <div className="space-y-2">
            <div className="p-4 bg-[#F9FAFB] rounded-[12px] border border-gray-200 max-h-[200px] overflow-y-auto">
              <div className="space-y-3">
                {Object.entries(variablesByCategory).map(([category, vars]) => {
                  const filteredVars = vars.filter((v) => v.code !== field);
                  ...
                  return (
                    <div key={category}>
                      <p className="text-[11px] font-semibold text-[#8B95A1] uppercase mb-1.5">
                        {category}
                      </p>
                      <div className="flex flex-wrap gap-1.5">
                        {filteredVars.map((variable) => (
                          <button
                            ...
                            type="button"
                            onClick={() => insertVariable(variable.label)}
                            className="px-2.5 py-1 bg-white border border-gray-200 rounded-[8px] text-[12px] text-[#191F28] hover:border-[#3182F6] hover:bg-[#E8F3FF] transition-colors"
